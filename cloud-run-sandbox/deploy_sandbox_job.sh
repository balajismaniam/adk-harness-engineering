#!/usr/bin/env bash
# deploy_sandbox_job.sh
# Automates deploying the Cloud Run Sandbox modernization agent to Google Cloud Run Jobs.
...
echo "================================================================="
echo "Deploying ADK Agent to Google Cloud Run Jobs with --sandbox-launcher"
echo "================================================================="
...
# 4. Deploy Cloud Run Job Directly from Source with Sandbox Launcher
echo "  [INFO] Deploying Cloud Run Job '$JOB_NAME' directly from source with --sandbox-launcher..."
...
echo "================================================================="
echo "Cloud Run Job deployed successfully from source!"
echo "To execute the modernization repair loop, run:"
echo "  gcloud beta run jobs execute $JOB_NAME --project=$GOOGLE_CLOUD_PROJECT --region=$CLOUD_RUN_REGION"
echo "================================================================="
